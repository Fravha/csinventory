...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-04-2026 a las 04:19:59
...
CREATE TABLE `almacenes` (
  ...
  `tipo_almacen` enum('REAL','VIRTUAL') NOT NULL DEFAULT 'REAL',
  `subtipo_almacen` enum('NORMAL','TRANSITO','PT','MERMA') NOT NULL DEFAULT 'NORMAL',
  `genera_alerta` tinyint(1) NOT NULL DEFAULT 1,
...
INSERT INTO `almacenes` (`idAlmacen`, `hashAlmacen`, `nombre`, `ubicacion`, `tipo_almacen`, `subtipo_almacen`, `genera_alerta`, `estado`, `deleted_at`) VALUES
(1, '0746bbefba5cd82b1e287f58f636bc54c2a2154ec6de0e910089ba60074a2f2c', 'Almacén Norte', 'Sección Distribución', 'REAL', 'NORMAL', 1, 1, NULL),
(2, 'f605925414e261d7628e1fe22b57c21fc34f12273cacca8d12517ce4026c72d5', 'Almacén Sur', 'Sección Recepción', 'REAL', 'NORMAL', 1, 1, NULL),
(3, '2a8b31fe8e99837eba32e65dee1a79afba4c3fea333ea24ae102a0f4f842e451', 'Almacén Tránsito', 'Mercancía en movimiento', 'VIRTUAL', 'TRANSITO', 0, 1, NULL),
(4, '2f38f65fe9d9a174558e3695ae28601778b670134cbd0dba4404c70e92761fce', 'Almacén PT', 'Producto Terminado', 'VIRTUAL', 'PT', 0, 1, NULL),
(5, '9866daef02ab8f82d3ef72d162f103117f3a8544f535ba57c13f6eae8ea85edf', 'Almacén Merma', 'Material Dañado/Desechos', 'VIRTUAL', 'MERMA', 0, 1, NULL),
(6, 'c1dfd96eea8cc2b62785275bca38ac261256e278', 'Almacen Este', 'Al este de la ciudad', 'REAL', 'NORMAL', 1, 1, NULL);
...
(6, 'c1dfd96eea8cc2b62785275bca38ac261256e278', 5, 2, 'LOT-20260422-43F', 15.00, 30.00, '2026-04-22', NULL);
...
(17, 5, 2, 'Entrada', 15.00, 'Compra Lote: LOT-20260422-43F', '2026-04-22 20:58:43'),
(22, 1, 2, 'Salida', 450.00, 'Consumo Produccion #3', '2026-04-22 21:21:03'),
(23, 3, 2, 'Salida', 15.00, 'Consumo Produccion #3', '2026-04-22 21:21:03'),
(24, 6, 4, 'Entrada', 15.00, 'Ingreso Produccion #3', '2026-04-22 21:21:03');
...
(2, 'da4b9237bacccdf19c0760cab7aec4a8359010b0', 'operador', NULL, 'Activo');
...
INSERT INTO `producciones` (`idProduccion`, `hashProduccion`, `idReceta`, `cantidad_producida`, `costo_total_lote`, `fecha_produccion`, `idUsuario`, `estado`) VALUES
(3, '80d2be2276295a5c31061c2cdf1c83830caa9cc4', 5, 15.00, 188.25, '2026-04-22 17:21:03', 1, 'Finalizado');
...
INSERT INTO `produccion_detalle` (`idProdDetalle`, `idProduccion`, `idProducto`, `cantidad_usada`, `precio_unitario_momento`) VALUES
(11, 3, 1, 450.0000, 0.40),
(12, 3, 3, 15.0000, 0.55);
...
(1, '356a192b7913b04c54574d18c28d46e6395428ab', 'Admin', 'admin', 0x24327924313024734b524a47444c7163563054554864436661596b564f586e77447361716c3458614e7048713331694a353179473843463153706432, 1, 'Activo'),
(2, '45c656a2ea97748a38944cb68ef45c51a45e2714', 'Francisco Bailaba', 'fravha', 0x24327924313024762f4966714c415050315a5a443430706454504d2e65426a4c45455a38396e3930552e3678646d615a3859737579564a79416d7761, 2, 'Activo'),
(3, '50fc0dfa2000257dc56d2d6ab50f6b34af62cf62', 'Operador', 'oper', 0x24327924313024472e7831775865672f6245437446707350333537504f7a333238525a6b5837566b6e386355584b68466a63314f7434336e784a3553, 2, 'Activo');
...
ALTER TABLE `almacenes`
  ...
  ADD KEY `idx_tipo_almacen` (`tipo_almacen`),
  ADD KEY `idx_subtipo_almacen` (`subtipo_almacen`),
  ADD KEY `idx_genera_alerta` (`genera_alerta`);
...
--
ALTER TABLE `almacenes`
  MODIFY `idAlmacen` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `movimientos`
  MODIFY `idMovimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `producciones`
  MODIFY `idProduccion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `produccion_detalle`
--
ALTER TABLE `produccion_detalle`
  MODIFY `idProdDetalle` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
