...
<div class='ctn-form'>
    ...
    <div class='form-content'>
        <div class='title'>Menu Produccion</div>
        <div class='menu'>
            <?php if (auth_can_action('produccion', 'view', $authSession)): ?>
                <div class='menu-item'>
                    <a href='../produccion/c-produccion-list.php'>
                        <div class='menu-item-pic ico-1'></div>
                        <div class='menu-item-title'>Lista de Producciones</div>
                        <div class='clear'></div>
                    </a>
                </div>
            <?php endif; ?>

            <?php if (auth_can_action('produccion', 'manage', $authSession)): ?>
                <div class='menu-item'>
                    <a href='../produccion/c-produccion-new.php'>
                        <div class='menu-item-pic ico-2'></div>
                        <div class='menu-item-title'>Nueva Produccion</div>
                        <div class='clear'></div>
                    </a>
                </div>
            <?php endif; ?>
